...
const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ label, error, leftIcon, rightIcon, fullWidth = true, className = '', ...props }, ref) => {
    const inputBaseClass = 'bg-dark-900 border text-dark-100 rounded-md block w-full p-2.5 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition';
